...
<%
    ...
    if(cids != null) cid=Integer.parseInt(cids);
...
<div class="main container">
    ...
    <nav style="text-align: center" aria-label="Page navigation">
        <ul class="pagination">
            <li>
                <a href="${pageContext.request.contextPath}/contests/status?pg=1&size=${size}&cid=${cid}&pid=${pid}" aria-label="Previous">
            ...
            <c:forEach begin="${st}" end="${ed}" var="i">
                ...
                ><a href="${pageContext.request.contextPath}/contests/status?pg=${i}&size=${size}&cid=${cid}&pid=${pid}">${i}</a></li>
            </c:forEach>
            <li>
                <a href="${pageContext.request.contextPath}/contests/status?pg=${maxn}&size=${size}&cid=${cid}&pid=${pid}" aria-label="Next">
