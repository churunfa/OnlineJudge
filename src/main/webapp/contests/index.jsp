                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${info}" var="data" varStatus="sta">
                                <tr>
                                    ...
                                    <td style="display:table-cell; vertical-align:middle;max-width: 150px"><img src="${pageContext.request.contextPath}${data.user.head_img}" alt="头像" class="img-circle" style="width: 30px"><a href="${pageContext.request.contextPath}/user?id=${data.user.id}" style="font-size: 20px;display: block">${data.user.name}</a></td>
